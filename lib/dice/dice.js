...
var dice = (function(){
  /*
   * Generated by PEG.js 0.7.0. with some modifications - Cindy
   *
   * http://pegjs.majda.cz/
   */
  ...
  var result = {
    ...
    parse: function(input, startRule) {
      this.intermediates = {}; // catches all intermediate rolled values - Cindy
      ...
      function parse_additive() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, left, right, sign) {
        	if (sign === '-') return left - right;
        	return left + right;
          })(pos0, result0[0], result0[2], result1);
        }
        if (result0 === null) {
          pos = pos0;
        }
